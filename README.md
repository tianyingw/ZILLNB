...
## 3 ZILLNB Running demo
We used the scRNA-seq dataset from mouse brain as demo[1]
### Case1: Without Covariates
```R
  source("/home/ZILLNB/Function_ZILLNB.R")
  cores_num = 10
...
## Reference
[1] Zeisel, A., et al. (2015). Cell types in the mouse cortex and hippocampus revealed by single-cell RNA-seq. Science 347, 1138–1142. doi: 10.1126/science.aaa1934
